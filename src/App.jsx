...
// and watch all seven matches play out. Stats are 2024-25 club-season form.
// ============================================================================

// 7-0 · 2026 edition. 24 nations, each a real best XI.
...
const SQUADS = [
  ...
  { nation:"Italy", flag:"🇮🇹", conf:"UEFA", players:[
    { name:"Gianluigi Donnarumma", club:"Paris SG", roles:["GK"], ovr:87, g:0, a:0, apps:43 },
    { name:"Giovanni Di Lorenzo", club:"Napoli", roles:["RB","RWB"], ovr:82, g:3, a:4, apps:36 },
    { name:"Alessandro Bastoni", club:"Inter", roles:["CB","LB"], ovr:85, g:3, a:5, apps:48 },
    { name:"Riccardo Calafiori", club:"Arsenal", roles:["CB","LB"], ovr:81, g:2, a:3, apps:33 },
    { name:"Federico Dimarco", club:"Inter", roles:["LB","LWB"], ovr:83, g:3, a:9, apps:47 },
    { name:"Nicolò Barella", club:"Inter", roles:["CM","CDM"], ovr:85, g:6, a:8, apps:50 },
    { name:"Sandro Tonali", club:"Newcastle", roles:["CDM","CM"], ovr:83, g:4, a:4, apps:48 },
    { name:"Davide Frattesi", club:"Inter", roles:["CM","CAM"], ovr:80, g:7, a:3, apps:43 },
    { name:"Federico Chiesa", club:"Liverpool", roles:["RW","ST"], ovr:80, g:2, a:1, apps:20 },
    { name:"Mateo Retegui", club:"Atalanta", roles:["ST"], ovr:83, g:25, a:6, apps:46 },
    { name:"Moise Kean", club:"Fiorentina", roles:["ST","LW"], ovr:82, g:19, a:3, apps:44 },
  ]},
  ...
  { nation:"Denmark", flag:"🇩🇰", conf:"UEFA", players:[
    { name:"Kasper Schmeichel", club:"Celtic", roles:["GK"], ovr:80, g:0, a:0, apps:46 },
    { name:"Joakim Mæhle", club:"Wolfsburg", roles:["RB","LWB"], ovr:79, g:2, a:4, apps:42 },
    { name:"Andreas Christensen", club:"Barcelona", roles:["CB"], ovr:82, g:1, a:1, apps:24 },
    { name:"Jannik Vestergaard", club:"Leicester", roles:["CB"], ovr:79, g:3, a:0, apps:36 },
    { name:"Victor Kristiansen", club:"Bologna", roles:["LB","LWB"], ovr:78, g:1, a:4, apps:42 },
    { name:"Pierre-Emile Højbjerg", club:"Marseille", roles:["CDM","CM"], ovr:82, g:3, a:5, apps:48 },
    { name:"Morten Hjulmand", club:"Sporting CP", roles:["CDM","CM"], ovr:81, g:3, a:3, apps:46 },
    { name:"Christian Eriksen", club:"Man United", roles:["CAM","CM"], ovr:80, g:4, a:6, apps:42 },
    { name:"Mikkel Damsgaard", club:"Brentford", roles:["CAM","LW"], ovr:80, g:5, a:11, apps:46 },
    { name:"Rasmus Højlund", club:"Man United", roles:["ST"], ovr:80, g:10, a:4, apps:50 },
    { name:"Jonas Wind", club:"Wolfsburg", roles:["ST"], ovr:79, g:13, a:5, apps:44 },
  ]},
  ...
  { nation:"Nigeria", flag:"🇳🇬", conf:"CAF", players:[
    { name:"Stanley Nwabali", club:"Chippa United", roles:["GK"], ovr:77, g:0, a:0, apps:34 },
    { name:"Ola Aina", club:"Nottingham Forest", roles:["RB","LB"], ovr:80, g:2, a:3, apps:44 },
    { name:"William Troost-Ekong", club:"Al-Kholood", roles:["CB"], ovr:79, g:3, a:1, apps:40 },
    { name:"Calvin Bassey", club:"Fulham", roles:["CB","LB"], ovr:80, g:2, a:2, apps:46 },
    { name:"Bruno Onyemaechi", club:"Olympiacos", roles:["LB","LWB"], ovr:77, g:1, a:4, apps:40 },
    { name:"Wilfred Ndidi", club:"Leicester", roles:["CDM","CM"], ovr:81, g:3, a:2, apps:40 },
    { name:"Alex Iwobi", club:"Fulham", roles:["CM","RW"], ovr:81, g:9, a:6, apps:50 },
    { name:"Frank Onyeka", club:"Augsburg", roles:["CM","CDM"], ovr:77, g:2, a:2, apps:40 },
    { name:"Ademola Lookman", club:"Atalanta", roles:["LW","ST"], ovr:84, g:20, a:9, apps:48 },
    { name:"Victor Osimhen", club:"Galatasaray", roles:["ST"], ovr:86, g:30, a:6, apps:46 },
    { name:"Samuel Chukwueze", club:"AC Milan", roles:["RW","LW"], ovr:80, g:6, a:5, apps:44 },
  ]},
  ...
  { nation:"Poland", flag:"🇵🇱", conf:"UEFA", players:[
    { name:"Łukasz Skorupski", club:"Bologna", roles:["GK"], ovr:79, g:0, a:0, apps:38 },
    { name:"Matty Cash", club:"Aston Villa", roles:["RB","RWB"], ovr:79, g:3, a:4, apps:40 },
    { name:"Jan Bednarek", club:"Southampton", roles:["CB"], ovr:78, g:2, a:0, apps:42 },
    { name:"Paweł Dawidowicz", club:"Verona", roles:["CB"], ovr:76, g:1, a:0, apps:36 },
    { name:"Bartosz Bereszyński", club:"Empoli", roles:["LB","RB"], ovr:75, g:0, a:3, apps:36 },
    { name:"Piotr Zieliński", club:"Inter", roles:["CM","CAM"], ovr:82, g:5, a:6, apps:44 },
    { name:"Sebastian Szymański", club:"Fenerbahçe", roles:["CAM","CM"], ovr:80, g:9, a:11, apps:48 },
    { name:"Nicola Zalewski", club:"Inter", roles:["LM","LWB"], ovr:78, g:3, a:7, apps:42 },
    { name:"Jakub Moder", club:"Brighton", roles:["CM","CDM"], ovr:77, g:2, a:3, apps:38 },
    { name:"Robert Lewandowski", club:"Barcelona", roles:["ST"], ovr:87, g:42, a:5, apps:52 },
    { name:"Karol Świderski", club:"Hellas Verona", roles:["ST","LW"], ovr:77, g:9, a:3, apps:40 },
  ]},
];
...
function simulateMatch(team, roundIdx, seed) {
  ...
  const oppRating = (knockout ? 82 + (roundIdx-3)*2.1 : 77 + roundIdx*1.3) + rnd(seed)*2.4;
  const pool = (roundIdx >= 4) ? OPP_GIANTS : (roundIdx === 3 ? [...OPP_GIANTS, ...OPP_POOL] : OPP_POOL);
...
const STAGE_LABELS = ["Group Match 1","Group Match 2","Group Match 3","Round of 16","Quarter-Final","Semi-Final","Final"];
function runTournament(team) {
  ...
  const champions = !eliminated && matches.length===7 && matches[6].result==="W";
...
function tierFor(tour){
  ...
  if(champions && r.draws===0 && r.losses===0 && r.wins===7) return { name:"7-0 — IMMORTAL", color:"#d4af37", note:"Seven games, seven wins. The perfect World Cup." };
  ...
  if(exitStage==="Round of 16") return { name:"Round of 16", color:"#5a6478", note:"Beaten in the first knockout round." };
      ...
      <header style={{ borderBottom:`3px double ${C.ink}`, background:C.paper, position:"sticky", top:0, zIndex:30 }}>
        <div style={{ ...maxw, padding:"10px 14px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          <div style={{ display:"flex", alignItems:"baseline", gap:9, cursor:"pointer", minWidth:0 }} onClick={()=>setScreen("home")}>
            <span style={{ ...display, fontSize:34, color:C.red }}>7&ndash;0</span>
  ...
  return (
    <main style={{ ...maxw, paddingTop:26, paddingBottom:20, animation:"slideUp .4s ease" }}>
      <div style={{ textAlign:"center", marginBottom:6 }}>
        ...
        <h1 style={{ ...display, fontSize:"clamp(40px,11vw,64px)", margin:"0 0 8px" }}>BUILD THE XI THAT GOES <span style={{ color:C.red }}>SEVEN&ndash;NIL</span></h1>
        <p style={{ fontFamily:"'Spectral', serif", fontSize:15, color:"#4a443a", maxWidth:440, margin:"0 auto", lineHeight:1.5 }}>
          Spin a nation from this summer's World Cup. Pick one player from their XI, and the rest of that squad is gone. Fill your formation, then watch all seven matches play out.
        </p>
      </div>
...
Think you can beat my ${recStr}? Build yours 👉`;

  async function shareTextNow() {
    const url = (typeof window!=="undefined" && window.location) ? window.location.href : "";
    const full = shareText + (url ? "\n" + url : "");
    try {
      if (navigator.share) { await navigator.share({ title:"7-0 · World Cup 2026", text: full }); return; }
  ...
  function buildCardCanvas() {
    ...
    // challenge footer
    ctx.fillStyle = C.ink; ctx.fillRect(0,H-86,W,78);
    ctx.fillStyle = C.gold; ctx.font = "700 20px Georgia"; ctx.textAlign="center";
    ctx.fillText(`Can you beat ${recStr}?`, W/2, H-50);
    ctx.fillStyle = C.paper; ctx.font = "14px Georgia";
    ctx.fillText("Build your World Cup 2026 XI", W/2, H-26);
    return cv;
  }
      ...
      cv.toBlob(async (blob)=> {
        ...
        try {
          if (navigator.canShare && navigator.canShare({ files:[file] }) && navigator.share) {
            await navigator.share({ files:[file], title:"7-0 · World Cup 2026", text:`My dream XI finished ${tier.name} (${recStr}). Beat it?` });
            return;
          }
